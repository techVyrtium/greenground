...
export default function NotFound() {
    ...
    return (
        <div className="p-5 mt-16 m-auto text-center w-11/12">
            ...
            <div>
                <Link href={'/products'} className="hover:underline font-bold text-[24px] text-[#008638]">{locale === 'en' ? "Go to products" : "Ir a productos"}</Link>
            </div>
            <Link href={'/'} className="hover:underline font-bold text-[24px] text-[#008638]">{locale === 'en' ? "Go to main page" : "Ir a la pagina principal"}</Link>
        </div>
    )
}