const Data = () => {
  const news = [
    {
      id: "familia-exportacion",
      title: "Una familia de exportación.",
      tipo: "novedades",
      description:
      ...
      section: (
        <>
          <p className="text-[30px] md:text-[36px] xl:text-[50px] 2xl:text-[60px] text-[#008638] font-itcGBold ">
            PRODUCTORA AGRÍCOLA AG, una familia de exportación
          </p>
          <p className="mb-6 text-[24px] mt-4 text-[#008638]">
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            fresco. La segunda generación, conformada por María y José Antonio
            Galán, madre y tío de Sebastián, ampliaron los horizontes hacia el
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            Allí hicieron contacto con una compañía interesada en el suministro
            de plátano.
          </p>
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            para determinar cómo pueden apoyar a potenciar el mercado de
            Productora Agricola AG SAS en el exterior.
          </p>
        </>
      ),
    },
      ...
      section: (
        <>
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            fundado tres décadas atrás por sus abuelos en Bogotá: vender
            hortalizas.
          </p>
          {/* <img src={"/news/prodAgricola.svg"} className="w-full" /> */}
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            exportación. Con la asesoría de ProColombia, hicieron estudios
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            oportunidad. Ahí se abrió una gran puerta: los canales
            institucionales en{" "}
          ...
          >
            <li className="mb-4 list-disc  ">
              Buscar clientes internacionales es una tarea ardua que requiere
              una estrategia. Por eso vale la pena asesorarse con ProColombia,
              que ayuda a abrir estas puertas.
            </li>
            <li className="mb-4">
              Por qué son una de las inversiones más emocionantes de nuestra
              era.
            </li>
            <li className="mb-4">
              Consolidar el crecimiento de la empresa -familiar- sobre la base
              de la unión y el respeto familiar. Sentimos que esta empresa es un
              legado de nuestros abuelos y tíos y la idea es que, a futuro, se
              pueda dar una transición generacional y quede en manos de los que
              vienen.
            </li>
          </ol>
          <div className="flex items-center justify-center w-full">
            <p className="mb-6 text-[24px] mt-4 text-[#4A4A4A] italic ">
        ...
        <>
          ...
          <div className="flex items-center justify-center ">
            <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A] text-center w-5/6">
              SU VALOR, LARGA VIDA Y FACILIDAD DE COCCIÓN SON ALGUNOS PUNTOS A
              FAVOR DE LOS CONGELADOS, QUE EN EL PAÍS{" "}
              <span className="font-bold">
                MUEVEN 189.000 MILLONES DE PESOS.
              </span>
            </p>
          </div>
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            como por un contexto de presupuestos reducidos y la búsqueda de
            menos desperdicios. Además, los congelados permiten espaciar los
            periodos de compras y son un respaldo de emergencia por su larga
            vida útil. Uno de los mercados donde más se consumen congelados es
            Estados Unidos. Allí no están comprando más, sino que están
            ensayando nuevos productos congelados y comprándolos en línea. En
            WGSN vieron que otro factor a favor de este tipo de alimentos es que
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            que compensó las menores ventas locales. Esta empresa familiar tiene
            sus orígenes en Corabastos, pero la segunda generación vio la
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            ultracongelan. Usan una tecnología de microcristales de hielo para
            que no se vea como la carne, que luce blanca y pálida en el
            congelador, sino como si estuvieran acabados de freír. Así hoy
            venden en cadenas de descuento en Estados Unidos, España, Australia,
            Chile, Perú y Canadá. El año pasado su facturación creció 27 por
            ciento y llegó a más de 2.150 millones de pesos. Sienten que en
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            solían consumir en la calle. Sostienen que es un mercado difícil de
            manejar, pues no se puede perder la cadena de frío y el trabajo está
            en convencer a los consumidores de que el producto congelado no ha
            dejado de ser fresco.
          </p>
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            institucional y cuyos productos ahora ofrecen al consumidor final-,
            los cambios en los hábitos de consumo por la pandemia y la necesidad
            de innovar.
          </p>
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            tenía capacidad de transporte en sus camiones refrigerados con los
            que atiende a sus diferentes sucursales y a los supermercados, se
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            marcas como Juan Váldez, La Fazenda, McCain, Koller, Europastry,
            Nestlé, El Kiosko, Pastas Carmis y The Cookie Jaar, esta última
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            panadería, masas para pizza y masas de galleta en rollo, entre
          ...
          <p className="mb-2 text-[24px] mt-4 text-[#4A4A4A]">
            ...
            recetas, que luego en casa solo requieren una cocción final. Estos
            cambios de hábitos por la pandemia no solo están transformando el
            espacio en los congeladores; también generan nuevas oportunidades de
            negocios.
          </p>
        </>
      ),
