...
export default function NotFound() {
    ...
    return (
        <div className="p-5 min-h-[50lvh] mt-16 m-auto text-center">
            ...
            <p className="mb-4 text-[min(26px,7vw)] md:text-[26px] mt-4 text-[#00863880] font-bold font-itcGBold leading-12">{locale === 'en' ? "Sorry, not exist page: " : "Lo sentimos, no existe la pagina: "}
                <span>{pathname}</span>
            </p>
