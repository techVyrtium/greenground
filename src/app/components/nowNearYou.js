...
export default function NowNearYou() {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-20 mt-20 w-full h-fit lg:h-[36rem] bg-[url(/home/bg-red.png)] bg-cover bg-no-repeat">
      <div className=" flex flex-col lg:flex-row ">
        <div className="lg:w-1/2 w-full flex items-center justify-center">
          <img src="/home/Frame171.png" className="w-[700px] h-auto" />
        </div>
        <div className="flex flex-col justify-around lg:w-1/2 w-full h-fit py-22">
          ...
          <div className="flex flex-row w-full items-center justify-center gap-8 py-8">
