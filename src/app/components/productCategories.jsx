...
const ProductCategory = ({ title, mainImage, mainImageWidth, mainImageHeight, href, sup, images = [], className = "", bgTitleType = "bold", classNameImage = "", classNameTitle = "" }) => {
    return (
        <Link href={href} className={`group w-[354px] md:w-[21.875rem] max-w-full h-56 text-center align-middle product-category-card rounded-lg cursor-pointer flex justify-center items-center relative overflow-hidden z-10 ${className}`}>
