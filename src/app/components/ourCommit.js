...
export default function OurCommit() {
  ...
  return (
    <section className="mt-24 w-full h-[60rem] md:h-[35rem]">
      {/* Zona Orange */}
      <div className=" h-[12rem] bg-[url(/home/bg-green.png)] bg-cover bg-no-repeat">
      ...
      <div className="max-w-7xl mx-auto flex flex-row h-[18rem] ">
        <div className="flex flex-row w-full">
          ...
          <div className="w-3/5">
            <div className="flex flex-row justify-end w-full -mt-36">
              <video
